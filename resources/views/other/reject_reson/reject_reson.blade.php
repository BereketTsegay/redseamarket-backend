                        ...
                        <tbody>
                            @foreach ($reson as $row)
                                <tr>
                                    ...
                                    @endif
                                    <td><button type="button" onclick="resonEdit({{$row->id}}, '{{$row->reson}}', '{{$row->description}}', {{$row->status}})" class="btn btn-secondary" data-toggle="modal" data-target="#editIconModal">Edit</button></td>
