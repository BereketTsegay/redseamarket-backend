    ...
    <main>
        <div class="container-fluid px-4">
            ...
            <div class="card mb-4">
                <div class="card-body">
                    <div class="container">
                        <form action="{{ route('make_mst.store') }}" method="POST" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-md-6">
                                    @csrf
                                    <div class="form-group my-2">
                                        <label for="Name">MakeMaster Name</label>
                                        <input type="text" name="make_mst_name" value="{{ old('make_mst_name') }}" class="slug form-control @error('make_mst_name') is-invalid @enderror" placeholder="MakeMaster Name" autocomplete="off">
