                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group my-2">
                                        ...
                                        <input type="text" name="arabic_name" value="{{ $category->arabic_name }}" class="form-control @error('arabic_name') is-invalid @enderror" placeholder="Category Name" autocomplete="off">
                                        <div class="invalid-feedback">
                                            @error('arabic_name')
                                                {{ $message }}
                                            @enderror
